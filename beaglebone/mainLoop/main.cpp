...
const int CHECK_GPS = 5; // Check the GPS buffer every 5 seconds
...
int main(){
  ...
  while (true){
    ...
    write_data(time,"m",x,y,z,roll,pitch,yaw,accData,compData,gyrData,60.7,13.4,fixQuality,numSatellites,0);
